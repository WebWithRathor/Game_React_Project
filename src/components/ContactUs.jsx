...
const ContactUs = () => {
  return (
    ...
    <div className="poster-headings w-1/2 pt-12">
      ...
      <button className='mt-2 px-6  font-semibold py-3 bg-[#8d1bb5] hover:bg-white hover:text-[#8d1bb5] transition-all shadow-[0_0px_15px_1px_#8d1bb5]  rounded text-lg text-white'>Aao contact krlo <i className="ri-arrow-right-line"></i></button>
